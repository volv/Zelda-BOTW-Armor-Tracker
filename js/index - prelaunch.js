...
var app = function () {
  var armor = [{
    ...
    checked: true,
    upgrades: [[{ name: "Bokoblin Horn", qty: 5 }], [{ name: "Bokoblin Horn", qty: 8 }, { name: "Bokoblin Fang", qty: 5 }], [{ name: "Bokoblin Guts", qty: 5 }, { name: "Bokoblin Fang", qty: 10 }], [{ name: "Bokoblin Guts", qty: 15 }, { name: "Amber", qty: 30 }]]
  }, {
    name: "Soldier's Set",
    pieces: [{ type: "Head", y: 9, x: 0 }, { type: "Chest", y: 9, x: 0 }, { type: "Leg", y: 9, x: 0 }],
    checked: true,
    upgrades: [[{ name: "Chuchu Jelly", qty: 5 }, { name: "Bokoblin Guts", qty: 3 }], [{ name: "Keese Eyeball", qty: 3 }, { name: "Moblin Guts", qty: 3 }], [{ name: "Lizalfos Tail", qty: 5 }, { name: "Hinox Guts", qty: 2 }], [{ name: "Lynel Hoof", qty: 4 }, { name: "Lynel Guts", qty: 2 }]]
  }, {
    name: "Snowquill Set",
    ...
    checked: true,
    upgrades: [[{ name: "Fireproof Lizard", qty: 3 }, { name: "Moblin Horn", qty: 3 }], [{ name: "Fireproof Lizard", qty: 5 }, { name: "Moblin Fang", qty: 5 }], [{ name: "Smotherwing Butterfly", qty: 5 }, { name: "Moblin Guts", qty: 3 }], [{ name: "Smotherwing Butterfly", qty: 8 }, { name: "Hinox Guts", qty: 5 }]]
  }, {
    name: "Zora Set",
    ...
    checked: true,
    upgrades: [[{ name: "Blue Nightshade", qty: 3 }], [{ name: "Blue Nightshade", qty: 5 }, { name: "Sunset Firefly", qty: 5 }], [{ name: "Silent Shroom", qty: 8 }, { name: "Sneaky River Snail", qty: 5 }], [{ name: "Silent Princess", qty: 5 }, { name: "Hearty Blueshell Snail", qty: 10 }]]
  }, {
    name: "Climbing Set",
    pieces: [{ type: "Head", y: 7, x: 0 }, { type: "Chest", y: 7, x: 0 }, { type: "Leg", y: 7, x: 0 }],
    checked: true,
    upgrades: [[{ name: "Keese Wing", qty: 3 }, { name: "Rushroom", qty: 3 }], [{ name: "Electric Keese Wing", qty: 5 }, { name: "Hightail Lizard", qty: 5 }], [{ name: "Ice Keese Wing", qty: 5 }, { name: "Hot-Footed Frog", qty: 10 }], [{ name: "Fire Keese Wing", qty: 5 }, { name: "Swift Violet", qty: 20 }]]
  }, {
    name: "Barbarian Set",
    pieces: [{ type: "Head", y: 12, x: 0 }, { type: "Chest", y: 14, x: 0 }, { type: "Leg", y: 13, x: 0 }],
    checked: true,
    upgrades: [[{ name: "Lynel Horn", qty: 3 }], [{ name: "Lynel Horn", qty: 5 }, { name: "Lynel Hoof", qty: 3 }], [{ name: "Lynel Guts", qty: 1 }, { name: "Lynel Hoof", qty: 8 }], [{ name: "Lynel Guts", qty: 2 }, { name: "Dragon Horns*", qty: 1 }]],
    individual: {
    ...
    checked: true,
    upgrades: [[{ name: "Luminous Stone", qty: 5 }, { name: "Bokoblin Guts", qty: 3 }], [{ name: "Luminous Stone", qty: 8 }, { name: "Moblin Guts", qty: 3 }], [{ name: "Luminous Stone", qty: 10 }, { name: "Molduga Guts", qty: 3 }], [{ name: "Luminous Stone", qty: 20 }, { name: "Lynel Guts", qty: 3 }]]
  }, {
    name: "Ancient Set",
    ...
    checked: true,
    upgrades: [[{ name: "Acorn", qty: 10 }, { name: "Dragon Bits*", qty: 2 }], [{ name: "Courser Bee Honey", qty: 5 }, { name: "Dragon Bits*", qty: 2 }], [{ name: "Energetic Rhino Beetle", qty: 5 }, { name: "Dragon Bits*", qty: 2 }], [{ name: "Star Fragment", qty: 1 }, { name: "Dragon Bits*", qty: 2 }]],
    individual: {
    ...
    checked: true,
    upgrades: [[{ name: "Molduga Fin", qty: 5 }, { name: "Hightail Lizard", qty: 10 }], [{ name: "Molduga Fin", qty: 10 }, { name: "Swift Carrot", qty: 10 }], [{ name: "Molduga Guts", qty: 3 }, { name: "Rushroom", qty: 15 }], [{ name: "Molduga Guts", qty: 5 }, { name: "Swift Violet", qty: 15 }]]
  }, {
    name: "Snow Boots",
    ...
    pieces: [{ type: "Head", y: 14, x: 15 }, { type: "Chest", y: 0, x: 0 }, { type: "Leg", y: 0, x: 0 }],
    checked: false,
    upgrades: [[{ name: "Ruby", qty: 1 }, { name: "Star Fragment", qty: 1 }], [{ name: "Ruby", qty: 3 }, { name: "Star Fragment", qty: 2 }], [{ name: "Ruby", qty: 5 }, { name: "Star Fragment", qty: 3 }], [{ name: "Ruby", qty: 10 }, { name: "Star Fragment", qty: 4 }]]
  }, {
    name: "Time Set (Amiibo)",
    pieces: [{ type: "Head", y: 14, x: 8 }, { type: "Chest", y: 0, x: 0 }, { type: "Leg", y: 14, x: 0 }],
    checked: false,
    upgrades: [[{ name: "Amber", qty: 3 }, { name: "Star Fragment", qty: 1 }], [{ name: "Amber", qty: 5 }, { name: "Star Fragment", qty: 2 }], [{ name: "Amber", qty: 15 }, { name: "Star Fragment", qty: 3 }], [{ name: "Amber", qty: 30 }, { name: "Star Fragment", qty: 4 }]]
  }, {
    name: "Twilight Set (Amiibo)",
    pieces: [{ type: "Head", y: 14, x: 10 }, { type: "Chest", y: 0, x: 0 }, { type: "Leg", y: 0, x: 0 }],
    checked: false,
    ...
    name: "Sky Set (Amiibo)",
    pieces: [{ type: "Head", y: 14, x: 9 }, { type: "Chest", y: 0, x: 0 }, { type: "Leg", y: 0, x: 0 }],
    checked: false,
    upgrades: [[{ name: "Sapphire", qty: 1 }, { name: "Star Fragment", qty: 1 }], [{ name: "Sapphire", qty: 3 }, { name: "Star Fragment", qty: 2 }], [{ name: "Sapphire", qty: 5 }, { name: "Star Fragment", qty: 3 }], [{ name: "Sapphire", qty: 10 }, { name: "Star Fragment", qty: 4 }]]
  }, {
    name: "Fierce Diety Set (Amiibo)",
    pieces: [{ type: "Head", y: 14, x: 11 }, { type: "Chest", y: 0, x: 0 }, { type: "Leg", y: 0, x: 0 }],
    checked: false,
    upgrades: [[{ name: "Hinox Toenail", qty: 5 }, { name: "Dragon Bits*", qty: 1 }], [{ name: "Hinox Tooth", qty: 5 }, { name: "Dragon Bits*", qty: 1 }], [{ name: "Hinox Guts", qty: 5 }, { name: "Dragon Bits*", qty: 1 }], [{ name: "Lynel Guts", qty: 5 }, { name: "Dragon Bits*", qty: 1 }]],
    individual: {
  ...
  function createSet(_ref) {
    ...
    for (var i = 0; i < 4; i++) {
      ...
      p.innerHTML = upgrades[i][0].name + ' x ' + upgrades[i][0].qty + '<br>';
